...
import {ScienceLibrary} from "../../src/lib";
...
describe("ScienceLibrary", () => {
  ...
  describe("createLibrary", () => {
    ...
    it("creates the right amount of members and librarians", () => {
      const lib = ScienceLibrary.createLibrary(books, members);
  ...
  describe("removeBook", () => {
    let lib: ScienceLibrary;

    beforeEach(() => {
      lib = ScienceLibrary.createLibrary(books, members);
    });
